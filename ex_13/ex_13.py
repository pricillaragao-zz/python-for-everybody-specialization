...
#     Actual data: http://py4e-data.dr-chuck.net/comments_745447.xml (Sum ends with 19)
#
...
# 1 - Download the XML data from a URL;
# 2 - Read and decode the data;
# 3 - Parse the XML;
# 4 - Collect the comment counts from the XML data in a list;
